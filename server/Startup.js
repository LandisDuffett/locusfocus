...
export default class Startup {
  static ConfigureGlobalMiddleware(app) {
    ...
    let whitelist = ["https://localhost:8080", "https://localhost:8081", "http://localhost:8080", "http://localhost:8081", "https://locusfocus.herokuapp.com", "http://locusfocus.herokuapp.com"];
    let corsOptions = {
